...
enum ts_symbol_identifiers {
  ...
  aux_sym_inline_comment_token1 = 45,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_type_identifier_character_set_1, 651, lookahead)) ADVANCE(147);
      END_STATE();
    case 1:
      if (lookahead == '\n') SKIP(2);
    ...
    case 84:
      ACCEPT_TOKEN(anon_sym_if);
      if (set_contains(sym_type_identifier_character_set_2, 800, lookahead)) ADVANCE(179);
      END_STATE();
    case 85:
    ...
    case 147:
      ...
      if (set_contains(sym_type_identifier_character_set_2, 800, lookahead)) ADVANCE(147);
      END_STATE();
    case 148:
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(151)] = 5242,
  [SMALL_STATE(152)] = 5256,
  [SMALL_STATE(153)] = 5270,
  [SMALL_STATE(154)] = 5284,
  [SMALL_STATE(155)] = 5298,
  [SMALL_STATE(156)] = 5312,
  [SMALL_STATE(157)] = 5326,
  [SMALL_STATE(158)] = 5340,
  [SMALL_STATE(159)] = 5354,
  [SMALL_STATE(160)] = 5368,
  [SMALL_STATE(161)] = 5382,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_expression, 3, 0, 9),
  ...
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 9, 0, 25),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_expression, 2, 0, 4),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_new_expression, 2, 0, 4),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_isvoid_expression, 2, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_isvoid_expression, 2, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_not_expression, 2, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, 0, 0),
  ...
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dispatch_expression, 2, 0, 5),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dispatch_expression, 2, 0, 5),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 3, 0, 8),
  ...
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 3, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dispatch_expression, 4, 0, 12),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dispatch_expression, 4, 0, 12),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 5, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean_literal, 1, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal, 1, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__literal, 1, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 5, 0, 13),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_expression, 5, 0, 13),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_expression, 5, 0, 14),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_expression, 5, 0, 14),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 5, 0, 15),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 5, 0, 15),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 4, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 4, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 6, 0, 16),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 6, 0, 18),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 6, 0, 18),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dispatch_expression, 6, 0, 20),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dispatch_expression, 6, 0, 20),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 7, 0, 21),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_expression, 7, 0, 21),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 7, 0, 22),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 8, 0, 23),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 4, 0, 11),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 4, 0, 11),
  ...
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_arm, 3, 0, 19),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 6, 0, 26),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_field_declaration_list_repeat1, 2, 0, 0),
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_field_declaration_list_repeat1, 2, 0, 0), SHIFT_REPEAT(97),
  ...
  [232] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(129),
  ...
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0),
  [255] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(98),
  [258] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(102),
  [261] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0),
  ...
  [269] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(155),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 2, 0, 17),
  [274] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(114),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = true}}, SHIFT(140),
  [281] = {.entry = {.count = 1, .reusable = true}}, SHIFT(134),
  [283] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_case_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(107),
  ...
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 0),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 0),
  ...
  [304] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 1, 0, 0),
  [306] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [309] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [311] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 4, 0, 24),
  ...
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_item, 5, 0, 2),
  [323] = {.entry = {.count = 1, .reusable = true}}, SHIFT(113),
  [325] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_declaration, 4, 0, 3),
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_declaration, 6, 0, 6),
  [331] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [333] = {.entry = {.count = 1, .reusable = false}}, SHIFT(154),
  [335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 6, 0, 7),
  [337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_field_declaration_list_repeat1, 1, 0, 0),
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_item, 4, 0, 1),
  ...
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 3),
  ...
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inherits, 2, 0, 0),
  [370] = {.entry = {.count = 1, .reusable = true}}, SHIFT(120),
  [372] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2, 0, 0),
  [376] = {.entry = {.count = 1, .reusable = true}}, SHIFT(152),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_declaration_list, 2, 0, 0),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_pattern, 3, 0, 3),
  ...
  [392] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3, 0, 0),
  ...
  [408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_declaration_list, 3, 0, 0),
  ...
  [416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_comment, 2, 0, 0),
  [418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3, 0, 0),
  [420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2, 0, 0),
};
