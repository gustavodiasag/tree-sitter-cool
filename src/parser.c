...
enum ts_symbol_identifiers {
  ...
  sym_case_arm = 77,
  sym_case_pattern = 78,
  sym_new_expression = 79,
  sym_isvoid_expression = 80,
  sym_not_expression = 81,
  ...
  aux_sym_field_declaration_list_repeat1 = 91,
  aux_sym_parameters_repeat1 = 92,
  aux_sym_arguments_repeat1 = 93,
  aux_sym_block_repeat1 = 94,
  aux_sym_let_expression_repeat1 = 95,
  aux_sym_case_expression_repeat1 = 96,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_type_identifier_character_set_1, 651, lookahead)) ADVANCE(201);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '"', 131,
    ...
    case 81:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(201);
      END_STATE();
    case 82:
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(143)] = 5655,
  [SMALL_STATE(144)] = 5672,
  [SMALL_STATE(145)] = 5686,
  [SMALL_STATE(146)] = 5700,
  [SMALL_STATE(147)] = 5714,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 1, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__type, 1, 0, 0),
  ...
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 10),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal, 1, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__literal, 1, 0, 0),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 3, 0, 8),
  ...
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_expression, 3, 0, 9),
  ...
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 4, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 4, 0, 12),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 4, 0, 12),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 3, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 3, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dispatch_expression, 4, 0, 13),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dispatch_expression, 4, 0, 13),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dispatch_expression, 2, 0, 7),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dispatch_expression, 2, 0, 7),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_expression, 2, 0, 6),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_new_expression, 2, 0, 6),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 5, 0, 14),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_expression, 5, 0, 14),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_expression, 5, 0, 15),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_expression, 5, 0, 15),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_isvoid_expression, 2, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_isvoid_expression, 2, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_not_expression, 2, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 5, 0, 12),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 5, 0, 12),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 5, 0, 16),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 5, 0, 16),
  ...
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 6, 0, 17),
  ...
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 6, 0, 16),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 6, 0, 16),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 6, 0, 19),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 6, 0, 19),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dispatch_expression, 6, 0, 21),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dispatch_expression, 6, 0, 21),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_expression, 7, 0, 22),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_expression, 7, 0, 22),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 7, 0, 23),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_expression, 7, 0, 19),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_case_expression, 7, 0, 19),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 8, 0, 24),
  ...
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 9, 0, 26),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 5, 0, 0),
  ...
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_arm, 3, 0, 20),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 6, 0, 27),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_declaration, 5, 0, 4),
  ...
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_field_declaration_list_repeat1, 2, 0, 0),
  [251] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_field_declaration_list_repeat1, 2, 0, 0), SHIFT_REPEAT(116),
  [254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [256] = {.entry = {.count = 1, .reusable = true}}, SHIFT(120),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0),
  [260] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(120),
  [263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0),
  [265] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(154),
  ...
  [276] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(112),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 2, 0, 0),
  ...
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_comment_repeat1, 1, 0, 0),
  [301] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [303] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [305] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  ...
  [322] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 2, 0, 18), SHIFT_REPEAT(168),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 2, 0, 18),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 0),
  [329] = {.entry = {.count = 1, .reusable = true}}, SHIFT(140),
  [331] = {.entry = {.count = 1, .reusable = true}}, SHIFT(163),
  [333] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_case_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(127),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_case_expression_repeat1, 2, 0, 0),
  [338] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [340] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [342] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  ...
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_let_expression_repeat1, 4, 0, 25),
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1, 0, 0),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_item, 4, 0, 1),
  [359] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 5),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_item, 6, 0, 2),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_declaration, 3, 0, 3),
  ...
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_declaration_list, 2, 0, 0),
  [382] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [384] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [386] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2, 0, 0),
  ...
  [406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 7, 0, 11),
  [408] = {.entry = {.count = 1, .reusable = true}}, SHIFT(136),
  [410] = {.entry = {.count = 1, .reusable = true}}, SHIFT(160),
  [412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_declaration_list, 3, 0, 0),
  ...
  [428] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3, 0, 0),
  [430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_comment, 2, 0, 0),
  [432] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2, 0, 0),
};
